...
class RNNModel(NERModel):
    ...
    def add_embedding(self):
        ...
        embedding_params = tf.constant(self.pretrained_embeddings)
        embeddings = tf.nn.embedding_lookup(embedding_params,ids=self.input_placeholder,partition_strategy='div')
    ...
    def add_prediction_op(self):
        ...
        preds = tf.reshape(preds,shape=(-1,Config.max_length, Config.n_classes))
        ### END YOUR CODE
    ...
    def add_loss_op(self, preds):
        ...
        """
        ### YOUR CODE HERE (~2-4 lines)
        loss_l = tf.nn.sparse_softmax_cross_entropy_with_logits(labels=self.labels_placeholder, logits = preds)
